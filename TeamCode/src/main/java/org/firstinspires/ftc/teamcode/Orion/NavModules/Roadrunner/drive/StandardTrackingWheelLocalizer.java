...
import org.firstinspires.ftc.teamcode.Orion.NavModules.Roadrunner.util.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, NavigationProfile navProfile) {
        ...
        FORWARD_OFFSET = navProfile.odometryProfile.FORWARD_OFFSET();
        X_MULTIPLIER = navProfile.tuningProfile.X_MULTIPLIER();
        Y_MULTIPLIER = navProfile.tuningProfile.Y_MULTIPLIER();
        ROT_LEFT = navProfile.odometryProfile.ROT_LEFT();
        ROT_RIGHT = navProfile.odometryProfile.ROT_RIGHT();
