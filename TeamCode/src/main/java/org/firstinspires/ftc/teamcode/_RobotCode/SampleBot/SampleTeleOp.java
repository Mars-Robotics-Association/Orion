...
import org.firstinspires.ftc.teamcode.Samples.Core.Robots.SampleRobot;
...
@TeleOp(name = "*SAMPLE TELEOP*", group = "All")
@Config
@Disabled
public class SampleTeleOp extends OpMode implements ControllerInputListener
{
    ////Dependencies////
    private SampleBot control;
    ...
    @Override
    public void init() {
        control = new SampleBot(this, true, false, false);
        control.Init();
