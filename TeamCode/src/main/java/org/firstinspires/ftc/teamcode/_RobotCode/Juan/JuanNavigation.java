...
@Config
class JuanNavigation extends UniversalThreeWheelNavigator
{
    ////Variables////
    ...
    public JuanNavigation(OpMode setOpMode, BaseRobot baseRobot) { //, DistanceSensor setDistancePort, DistanceSensor setDistanceStarboard, ColorSensor setColorSensor) {
