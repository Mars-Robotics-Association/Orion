...
public class CuriosityAutoLeft extends LinearOpMode {
    ...
    public void goToStack() throws InterruptedException {
        goToPose(conePickupX, conePickupY*sideMultiplier, 90*sideMultiplier, .6);
